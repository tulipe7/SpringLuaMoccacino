...
/*
Kills the team
@param teamID number Id of the team to murder
*/
...
@param teamID number Id of the team
*/
...
/*
Declare the Game finnished
@param winningAllyTeams table  
*/
...
/*
Set the global Line of Sight 
@param allyTeam  number 
@param boolean losEnabled
*/
...
UseTeamResource
@param teamID number
@param type string | table ressources
@param amount number 
*/
...
/*
CreateUnit
@param unitTypeDefId number | unitTypeDefId string
@param x number
@param y number
@param z number
@param  facing number
@param teamID number
@param  beingBuilt boolean 
@param  flattenGround boolean 	
@param  unitID number 	
...
SetUnitHealth
@param  unitID number 	
@param health number | healthinfotable table
*/
...
SetUnitStockpile
@param  unitID number 	
@param numStockpiled number
@param stockpileWeapon number
*/
...
@param weaponKey number | weaponTable table
@param weaponValue number
*/
...
@param  unitID number 	
@param key string
@param weaponValue number | weaponTable table
*/
...
SetUnitCloak
@param unitID number 	
@param scriptCloak boolean
@param decloakDistance number
*/
...
@param unitID number 	
@param SetWorldObjectAlwaysVisible boolean
*/
...
@param unitID number 	
@param harvest table [SResourcePack::MAX_RESOURCES]{harvested number -> harvestStorage number}
*/
...
SetUnitNanoPieces
@param unitID number 	
@param nanopieces table [..]{modelPieceNum number} 
*/
...
SetUnitShieldState
@param unitID number 	
@param shieldsState table[..]{{SetEnabled boolean, SetCurPower number}}
*/
...
@param unitID number 	
@param key string
|@param flankingBonusMode number
|@param dir
|dirx number
|diry number
|dirz number
|@param moveFactor
| flankingBonusMobilityAdd number
|@param minDamage
| minDamage number
*/
...
SetUnitNeutral
@param unitID number 	
@param WhatDoesItTakeToMakeaManNeutral boolean
*/
...
SetUnitMidAndAimPos
@param unitID number 	
@param midPosx number 	
@param midPosy number 	
@param midPosz number 	
@param aimPosx number 	
@param aimPosy number 	
@param aimPosz number 	
...
SetUnitPieceParent
@param unitID number 	
@param lmpAlteredPiece number 	
@param lmpParentPiece number 	
*/
...
SetUnitLandGoal
@param unitID number 	
@param landPosx number 	
@param landPosy number 	
@param landPosz number 	
...
@param landPosx number 	
@param landPosy number 	
@param landPosz number 	| getHeightAtXZ boolean
...
@param facing number | facing string
*/
